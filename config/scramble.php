...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Register or log in to receive a Sanctum token, then send it as `Authorization: Bearer <token>` to manage projects.',
    ],
    ...
    'renderers' => [
        /*
         * Swagger UI config options: https://swagger.io/docs/open-source-tools/swagger-ui/usage/configuration/
         */
        'swagger' => [
            'view' => 'scramble::swagger',
    ...
    /*
     * Routes behind `auth` / `auth:*` middleware (here `auth:sanctum`) are documented as requiring a
     * bearer token; every other route (register, login) is documented as public.
     */
